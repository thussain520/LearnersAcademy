...
<head>
  ...
  <title>Add New Subject | Learners Academy</title>
  ...
  <script>
        ...
        function AddSubject()
        {
		    var subjectName = $("#addSubjectId").val()
		    if(subjectName == "")
	    	{
		    ...
		    $.ajax({
		    	  type: "POST",
		          url: "AjaxProcess.jsp",
		          data: {act:"AddSubject", subjectName: subjectName},
		          success:function(response){
	            	...
	            	{
		            	alert("There is an error in saving new Subject");
	            	}
		          }
		    });
        }
              ...
              <form id="quickForm">
                <div class="card-body">
                  <div class="form-group">
                    <input type="text" name="addSubject" class="form-control" id="addSubjectId" placeholder="Enter New Subject Name">
                  </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List of all available subjects</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                 ...
                 Query query=sessionObj.createQuery("select s.subName, u.name, s.creationDate from Subjects as s INNER JOIN s.user as u");
