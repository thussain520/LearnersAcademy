...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.learnersacademy.Classes, com.learnersacademy.ConnectUtility" %> 
<%
...
<head>
  ...
  <title>Add New Class | Learners Academy</title>
  ...
  <script>
        ...
        function AddClass()
        {
		    ...
		    $.ajax({
		    	  type: "POST",
		          url: "AjaxProcess.jsp",
		          data: {act:"AddClass", className: className},
		          success:function(response){
	            	...
	            	{
		            	alert("There is an error in saving new class");
	            	}
		          }
		    });
        }
              ...
              <form id="quickForm">
                <div class="card-body">
                  <div class="form-group">
                    <input type="text" name="addClass" class="form-control" id="addClassId" placeholder="Enter New Class Name">
                  </div>
                  <button type="button" onclick="javascript:AddClass();" class="btn btn-primary">Add Class</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List of all available classes</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                 ...
                 Query query=sessionObj.createQuery("select c.className, u.name, c.creationDate from Classes as c INNER JOIN c.user as u");
                 List<Object[]> list = query.getResultList();
                 for(Object[] c : list)
                 {
                	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
         			Date date = sdf.parse(c[2].toString());
                 %> 
